	...
	<div uk-grid>
		<div class="uk-width-1-1@s">
			<div class="top-menu" uk-sticky>
				...
				<div uk-grid>
				<div class="uk-width-2-3 uk-hidden@m" style="margin-left: 10px"> <a href="mailto:manor-house.21@yandex.ru" style="margin-bottom: 5px; color:#000"><i class="far fa-envelope" style="margin-right: 10px"></i>manor-house.21@yandex.ru</p>
						...
						<div id="offcanvas-nav" class="" uk-dropdown>
							<div class="">
								...
								<!-- <ul class="uk-nav uk-dropdown-nav">
									...
									<li><a href="#about" uk-scroll>РЕСТОРАН И БАНКЕТНЫЙ ЗАЛ</a></li>
									<li><a href="#about" uk-scroll>МЕРОПРИЯТИЯ</a></li>
